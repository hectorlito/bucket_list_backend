...
class ListItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create list_item" do
    assert_difference('ListItem.count') do
      post list_items_url, params: { list_item: { content: @list_item.content, img: @list_item.img, title: @list_item.title } }, as: :json
    end
  ...
  test "should update list_item" do
    patch list_item_url(@list_item), params: { list_item: { content: @list_item.content, img: @list_item.img, title: @list_item.title } }, as: :json
    assert_response 200
  end
